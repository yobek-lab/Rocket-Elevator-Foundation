...
namespace :transfer do   #---rake transfer: data---#
    ...
    task data: :environment do
        ...
        #Anna's Local Postgres Database
        #connected = PG::Connection.open(host: "localhost", port: 5432, dbname: "postgresdb", user: "littlepinky", password: "" )
    ...
    #Jackie's team previous code for the weeks before -- 
    #     # prepares all the queries
